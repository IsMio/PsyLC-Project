...
from core.emotion_recognition import analyze_sentiment, create_emotional_response
from core.sqlite_chat_store import SQLiteChatStore
from core.tool import TokenVerificationTool
...
async def send_message(req: type.ChatRequest, request: Request):
    ...
    try:
        ...
        if hasattr(request.state, "user") and request.state.user:
            user_id = request.state.user.get("user_id", req.userId or "anonymous")
        else:
